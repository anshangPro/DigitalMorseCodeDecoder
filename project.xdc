...
#buzzer switch
set_property PACKAGE_PIN V5 [get_ports {beep_sw1}]
set_property IOSTANDARD LVCMOS33 [get_ports {beep_sw1}]
set_property PACKAGE_PIN R6 [get_ports {beep_sw2}]
set_property IOSTANDARD LVCMOS33 [get_ports {beep_sw2}]
set_property PACKAGE_PIN T6 [get_ports {beep_sw3}]
